...
public class DAOConsultaTest {
	...
	public static void main(String[] args) {
		 ...
		 * secretaria.setCpf("222.222.222-22"); Calendar dateSecretaria =
		 * Calendar.getInstance(); dateSecretaria.set(1994, Calendar.JANUARY, 24);
		 * secretaria.setDtNascimento(dateSecretaria);
		 * secretaria.setEstadoCivil("Solteira"); secretaria.setRg("2.222.222SDS/PE");
		 * secretaria.setContato("2424-2424");
		 * 
		 * 
		 * paciente.setNome("Mirosmar"); paciente.setEmail("mirosmart@gmail.com");
		 ...
		 * paciente.getEndereco().setUf("PE"); paciente.getEndereco().setPais("Brasil");
		 * paciente.setCpf("333.333.333-33"); Calendar datePaciente =
		 * Calendar.getInstance(); dateSecretaria.set(1994, Calendar.JANUARY, 24);
		 * paciente.setDtNascimento(datePaciente); paciente.setEstadoCivil("Casado");
		 * paciente.setRg("3.333.333SDS/PE"); paciente.setContato("3030-2020");
		 */
		...
		ConsultaDAO factory = DAOFactory.getConsultaDAO();
		factory.insert(consulta);
	}
